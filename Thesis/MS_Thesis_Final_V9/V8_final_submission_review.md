...
5. ~~Inference-time claims conflict with included tables.~~
   ...
   - Resolved in V9 by replacing the isolated timing artifact with the matching old merged-table value, `3.7595 [3.7363, 3.7845] ms`, and pointing the results figure to the coherent old figure asset.
