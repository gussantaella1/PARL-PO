...
\centering
\footnotesize
\caption{Case-specific values for the velocity dispersion and the KF measured noise on the adversary's control action. For the three KF-on runs considered here, the measured-control noise was the same across all test cases.}
...
Measured-control noise, \texttt{action\_meas\_std} & Gaussian & See Table~\ref{tab:mc-dispersions-policy-specific} & Mean is $0$, and the standard deviation is $0.025~\mathrm{m/s^2}$. \\
