...
def plot_aggregate_one_column(use_kf: bool) -> Path:
    ...
    fig.subplots_adjust(left=0.095, right=0.985, top=0.90, bottom=0.035, hspace=0.46)
...
def plot_policy_phase_one_column(policy_dir: str, policy_label: str, use_kf: bool) -> Path:
    ...
    fig.subplots_adjust(left=0.075, right=0.99, top=0.875, bottom=0.025, hspace=0.70)
