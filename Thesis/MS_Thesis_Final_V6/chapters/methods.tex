...
\begin{figure}[H]
    ...
    \caption{Diagram showing the PARL + BC algorithm's learning loop within the \acs{gnc} architecture constrained by the \acs{ekf} and the Classical \acs{cbfqp} controller}
