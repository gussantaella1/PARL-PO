...
\begin{itemize}
    ...
    \item We're dealing with small distances relative to the celestial object being orbited $\| (x,y,z)\| \ll r_0$
...
\begin{table}[H]
\centering
\caption{Chief orbit parameters used for the HCW and elliptic dynamics.}
\label{tab:chief-orbit-parameters}
\begin{tabular}{lcc}
\toprule
\textbf{Parameter} & \textbf{HCW circular orbit} & \textbf{Elliptic orbit} \\
\midrule
...
\begin{figure}[H]
    ...
    \caption{Chief orbit geometry used for the HCW and elliptic dynamics, showing the circular training/evaluation orbit and the elliptic evaluation-only orbit. Credits of the image of the  go to the Artemis II crew (\cite{apod2026helloworld})}
