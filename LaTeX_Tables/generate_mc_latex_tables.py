...
def write_merged_thesis_tables(
    ...
    for run_spec in present_base_specs:
        ...
        copy_training_curve(base_run_dir, merged_dir, "combined_training_curve_kf_off.png")
        copy_training_curve(kf_on_run_dir, merged_dir, "combined_training_curve_kf_on.png")
...
def write_table_set(
    ...
    aggregate_parts = [
        ...
        f"% Tables use [{TABLE_PLACEMENT}] placement.",
